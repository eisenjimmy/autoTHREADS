...
![Version](https://img.shields.io/badge/version-0.2.16-111111?style=flat-square)
...
> [!TIP]
> **Current release: v0.2.16.** **Local vision** for reply images, **current date/time** in system
...
Prebuilt macOS + Windows installers: [GitHub Releases](https://github.com/eisenjimmy/autoTHREADS/releases) (latest **v0.2.16**).
...
설치 파일 (macOS + Windows): [Releases](https://github.com/eisenjimmy/autoTHREADS/releases) (최신 **v0.2.16**)
